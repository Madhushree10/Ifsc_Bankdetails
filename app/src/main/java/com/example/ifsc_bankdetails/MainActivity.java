...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void spinnerInflater(){
        Spinner spinnerBank = findViewById(R.id.spBank);
        ...
        Spinner spinnerState = findViewById(R.id.spState);
        ...
        Spinner spinnerDistrict = findViewById(R.id.spDistrict);
        ...
        Spinner spinnerBranch = findViewById(R.id.spBranch);
    ...
    public void getBranch(){
        String URL_DISTRICT = "http://api.techm.co.in/api/district/" + district;
    ...
    public void getIfscCode(){
        String URL_BRANCH = "http://api.techm.co.in/api/getbank/" + myBank + "/" + branch;
